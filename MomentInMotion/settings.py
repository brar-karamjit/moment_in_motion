"""
Django settings for MomentInMotion project.
...
LOGIN_URL = 'accounts:login'            # redirect here if user is not logged in
...
ROOT_URLCONF = 'MomentInMotion.urls'
...
WSGI_APPLICATION = 'MomentInMotion.wsgi.application'
